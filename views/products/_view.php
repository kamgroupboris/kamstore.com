...
<div class="container bb">
    ...
    <p class="StileTextParam2 cb">Samsung SM-B310E White</p>
    </div>
    </div>
<!--
Start content
            ...
            <div class="col-xs-7">
                ...
                <div class="container_fo_scroll">
                    <div class="main-image">
                        <img src="images/img_1.jpg" alt="Placeholder" class="custom">
                    </div>
                    <div id="demo-left" class="thumbnails">
                       ...
                       /*         foreach($images as $img){
                                    //   print('<pre>');  print_r($img->attributes);
                                }*/
                                ...
                                <?// foreach($images as $img):?>
                                    <div><?// print('<pre>');  print_r($img); ?>
                                        <a href="images/img_4.jpg"><img src="/files/products/<?//=str_replace(".", ".300x300.", $img->attributes['filename'])?>" alt="Thumbnails"></a>
                                    </div>
                                <?//endforeach;?>
                              <!--  <div>
