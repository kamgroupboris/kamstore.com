...
<div class="product-thumb transition product-item-container">
			...
			<div class="product-image-container">
								...
								<img data-src="/files/products/<?= str_replace(".", ".200x200.",$img1['filename'])?>" src="/files/products/<?= str_replace(".", ".200x200.",$img1['filename'])?>" alt="Phasellus ut vehicula" class="img-responsive"  />
						</a>
			    </div>			
			    			    				    <!--full quick view block-->
					    					    <a class="quickview iframe-link visible-lg" data-toggle="tooltip" title="Быстрый просмотр" data-fancybox-type="iframe"  href="index.php@route=product%252Fquickview&amp;product_id=52.html">  Быстрый просмотр</a>
				   				    ...
				   				    <div class="rating">
										...
										<span class="price-new"><?if(isset($variants1[0]['price']))echo $variants1[0]['price'];?>₽</span> <span class="price-old"><?if(isset($variants1[0]['compare_price']))echo $variants1[0]['compare_price'];?>₽</span>
						    							    ...
						    							    <div class="button-group">
							    								    ...
							    								    <button type="button" class="compare" data-toggle="tooltip" title="Сравнить" onclick="compare.add('<?= $model['id'] ?>');"><i class="fa fa-exchange"></i></button>
